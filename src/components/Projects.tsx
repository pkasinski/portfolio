      ...
      <div className="container">
        ...
        <div className="container-inner">
          ...
          <Project
            ...
            description="While building my portfolio website, I knew early on that I wanted to include an animation where text is written out as if someone was typing it. I began using an existing package to achieve this effect, but after realizing I could not customize the component how I wanted to, I decided to recreate such a component with options that suited me. Not only was this practical, but it was also interesting to get a better understanding of the inner workings of such a component by creating it from scratch. The component has been used on multiple occasions on the website that you are currently viewing."
